...
public class VerTokens extends javax.swing.JDialog {
    ...
    public VerTokens(java.awt.Frame parent, boolean modal, String dirNuevo, GUICompiladorC gui) {
        ...
        initComponents();
        this.setTitle("Ver tokens");
        this.setLocationRelativeTo(null);/*Esto esta atrapado en un try catch por si el archivo se encuentra vacio*/
        try {
            gui.Guardar();
            Process p = Runtime.getRuntime().exec("../Analizadorls.exe " + dirNuevo);/*Se leen los tokens con el ejecutable (.exe)*/
            p.waitFor();
            ...
            while(line!=null && el.length<2) {
                ...
                ob[1]=yytname[id];/*id del token*/
                ob[0]=yytoknum[id];/*palabra reservada*/
    ...
    public javax.swing.JTable tokens;
